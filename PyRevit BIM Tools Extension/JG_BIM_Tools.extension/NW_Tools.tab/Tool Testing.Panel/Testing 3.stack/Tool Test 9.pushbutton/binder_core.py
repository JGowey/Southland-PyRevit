...
_ALIAS_TO_TOKEN = {
    ...
    "ELECTRICAL_-_LIGHTING": "LIGHTING",
...
_G23 = {
    ...
    "IFC_PARAMETERS": _gt("IFCParameters"),
    "LAYERS": _gt("Layers"),
    "LIFE_SAFETY": _gt("LifeSafety"),
    "MATERIALS_AND_FINISHES": _gt("MaterialsAndFinishes"),
    "MECHANICAL": _gt("Mechanical"),
    "MECHANICAL_FLOW": _gt("MechanicalFlow"),
    "MECHANICAL_LOADS": _gt("MechanicalLoads"),
    "MODEL_PROPERTIES": _gt("ModelProperties"),
    "MOMENTS": _gt("Moments"),
    "OVERALL_LEGEND": _gt("OverallLegend"),
    "PHASING": _gt("Phasing"),
    "PHOTOMETRICS": _gt("Photometrics"),
    ...
    "SEGMENTS_AND_FITTINGS": _gt("SegmentsAndFittings"),
    "SET": _gt("Set"),
