...
def mode1_create_per_space():
    ...
    try:
        deleted = delete_old_generated(doc, [PREFIX_MODE1, PREFIX_MODE2, PREFIX_MODE3, PREFIX_MODE4])
...
# ---------------- MODE 4 (READ OTHER DOC, WRITE ACTIVE DOC) ----------------
...
def mode4_import_merged_from_other_doc_into_active():
    ...
    try:
        if do_clear:
            deleted = delete_old_generated(target_doc, [PREFIX_MODE1, PREFIX_MODE2, PREFIX_MODE3, PREFIX_MODE4])
