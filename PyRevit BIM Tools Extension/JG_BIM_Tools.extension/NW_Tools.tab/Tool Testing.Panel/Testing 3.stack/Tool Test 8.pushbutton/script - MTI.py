# -*- coding: utf-8 -*-
"""
pyRevit - Modeless "MTI Parameter Writer" (ExternalEvent)

UI defaults per request:
  - Checked by default:
      * Job Number
      * New Scope - Yes
      * Micron Zone
      ...
      * Only elements I own
      * Sync with Central
  - Unchecked by default (grouped under "Optional (default OFF):"):
      * Future Scope - No
      * Demo Scope - No
      * Record Scope - No
  - Scope default:
      * Entire Model (checked by default)

UI layout tweaks:
  - Optional OFF group placed below primary outputs with a header
  - Window slightly taller
  - Report area uses scrollbars (TextBox scrollbars enabled) and more vertical space
...
# CONFIG
# -----------------------------------------------------------------------------
WINDOW_TITLE = "MTI Parameter Writer"
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
  ...
  <Grid Margin="12">
    ...
    <StackPanel Grid.Row="1" Orientation="Vertical" Margin="0,0,0,10">
      ...
      <CheckBox x:Name="ChkZone"  Content="Write Micron Zone (Scope_Const_Work_Pkg_Ext_MTI)" IsChecked="True" Margin="0,2,0,2"/>

      <Separator Margin="0,8,0,8"/>

      <CheckBox x:Name="ChkStatus" Content="Write Construction Status (Scope_Coord_Status_External_MTI)" IsChecked="True" Margin="0,2,0,6"/>
    ...
    <TextBlock Grid.Row="2" Text="Options:" FontWeight="SemiBold" Margin="0,0,0,6"/>
    ...
    <TextBlock Grid.Row="4" Text="Scope:" FontWeight="SemiBold" Margin="0,0,0,6"/>
