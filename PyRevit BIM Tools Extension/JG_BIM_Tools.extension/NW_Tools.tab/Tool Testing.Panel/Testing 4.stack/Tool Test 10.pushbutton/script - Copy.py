...
HELP_PROFILE_MANAGER = (
    ...
    "  Import JSON      Load a profile from a file someone shared.\n"
    "  Export JSON      Save the selected profile to share with others.\n"
    "\n"
    "THE ACTIVE BADGE:\n"
    ...
    "  3. Click 'Set active' so the BOM run button picks it up.\n"
    "  4. Run the BOM as normal -- extra columns appear at the right.\n"
...
class EditColumnDialog(Form):
    ...
    def _build_ui(self):
        ...
        btn_help.Location = Point(self.ClientSize.Width - 44, 8)
        ...
        self._txt_param.Size     = Size(350, 24)
        self.Controls.Add(self._txt_param)

        btn_browse = Button()
        btn_browse.Text     = "Browse..."
        btn_browse.Location = Point(pad + 358, row - 2)
        ...
        self._txt_display.Size     = Size(450, 24)
        ...
        self._cmb_unit.Size          = Size(350, 24)
        ...
        self._lbl_note.Size      = Size(450, 36)
        ...
        self.ClientSize = Size(490, row + 52)
...
class ProfileManagerDialog(Form):
    ...
    def _build_ui(self):
        ...
        btn_help.Text     = "?"
        btn_help.Size     = Size(28, 28)
        btn_help.Location = Point(total_w - 36, pad)
    ...
    def _refresh_list(self, keep_name=None):
        ...
        for i, name in enumerate(profiles):
            ...
            self._lst.Items.Add("{}{}".format(name, badge))
            if name == keep_name:
                keep_index = i
    ...
    def _selected_name(self):
        ...
        if item is None:
            return None
        return item.replace("  [ACTIVE]", "").strip()
    ...
    def _prompt_name(self, prompt, default):
        ...
        lbl.Size     = Size(320, 18)
        dlg.Controls.Add(lbl)

        txt = TextBox()
        txt.Text     = default
        txt.Location = Point(12, 36)
        txt.Size     = Size(320, 24)
        ...
        btn_cancel = Button()
        btn_cancel.Text     = "Cancel"
        btn_cancel.Location = Point(104, 72)
