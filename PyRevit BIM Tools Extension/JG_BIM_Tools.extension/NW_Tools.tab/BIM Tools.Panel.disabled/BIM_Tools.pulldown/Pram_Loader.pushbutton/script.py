...
# Only import binder_core at the top because the main UI needs it.
import binder_core as core


# --------------------- START OF LAUNCHER CODE ---------------------
...
class Launcher(Form):
    def __init__(self):
        ...
        def _layout(_s=None,_a=None):
            ...
            x = 12
            # Handle all buttons except Refresh and Close
    ...
    # actions
    def _create(self, *_):
        # Now importing ui_builder just before it's needed
...
# This is the original start script logic
try:
