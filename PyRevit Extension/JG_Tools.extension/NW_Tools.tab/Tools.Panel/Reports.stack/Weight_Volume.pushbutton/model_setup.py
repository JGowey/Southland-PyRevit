...
class ModelSetupWindow(object):
    def __init__(self):
        ...
        # Disable schedule import options when in Family Editor (RFA)
        try:
            if revit.doc and revit.doc.IsFamilyDocument:
                self.ChkWeight.IsEnabled = False
                self.ChkQC.IsEnabled = False
                self.ChkCat.IsEnabled = False
        except:
            pass
